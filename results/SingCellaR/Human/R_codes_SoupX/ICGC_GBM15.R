...
my.umi<-readRDS("../../../cellranger_results/human/K35R-sn_ICGC_GBM15/ICGC_GBM15.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"ICGC_GBM15",sep="_")

human<-new("SingCellaR")
human@sample_uniq_id<-"ICGC_GBM15"
...
save(human,file="ICGC_GBM15.SingCellaR.rdata")
