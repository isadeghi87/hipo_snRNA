...
human<-readRDS(file="K27M_PDX_SoupX.SingCellaR.No_batch_correction.rds")
...
################Harmony2##################
SrunHarmony(human,covariates = c("sampleID","sequencer"),
            n.dims.use = 30,harmony.max.iter = 10,
            n.seed = 1,harmony.theta = c(5,5))
...
SingCellaR::identifyClusters(human,useIntegrativeEmbeddings = T,
                             ...
                             n.dims.use = 30,n.neighbors = 40, 
                             knn.metric = "euclidean")

plot_umap_label_by_clusters(human,show_method = "louvain")

saveRDS(human,file="K27M_PDX_samples.SoupX.SingCellaR.Harmony_v1.rds")
################CCA######################