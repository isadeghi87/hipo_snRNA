...
mouse@dir_path_SingCellR_object_files<-"./"
mouse@SingCellR_object_files=c("9T.SingCellaR.rdata",
                               "Tr001.SingCellaR.rdata",
                               "Tr015.SingCellaR.rdata",
                               "Tr089.SingCellaR.rdata",
                               "Tr091.SingCellaR.rdata",
                               "Tr110.SingCellaR.rdata",
                               "Tr074.SingCellaR.rdata",
                               "Tr075.SingCellaR.rdata",
                               "Tr085.SingCellaR.rdata",
                               "Tr086.SingCellaR.rdata",
                               "NSG_pons_cntrl.SingCellaR.rdata",
                               "NSG_cortex_cntrl.SingCellaR.rdata",
                               "CD1_pons_cntrl.SingCellaR.rdata",
                               "CD1_cortex_cntrl.SingCellaR.rdata")
...
saveRDS(mouse,file="mouse_SingCellaR_no_batch_correction.rds")
