...
my.umi<-readRDS("../../../cellranger_results/human/K35R-VFHB3C/ICGC_GBM96.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"ICGC_GBM96",sep="_")

sce<-SingleCellExperiment(assays = list(counts = my.umi))
human <-new("SingCellaR",sce)

human@sample_uniq_id<-"ICGC_GBM96"
...
runUMAP(human,dim_reduction_method = "pca",n.dims.use = 20,n.neighbors = 30,
...
save(human,file="ICGC_GBM96.SingCellaR.rdata")
