...
p[[1]]<-plot_umap_label_by_AUCell_score(human,AUCell_gene_set_name = "Astrocyte-like",AUCell_cutoff = 0.1,
                                        ...
                                        IsShowOnlySampleIDs = T,IsDownsample = T,downsample.size = 3200,point.size = 0.1,
                                        ,showLegend = F)
...
pdf(file="AUCell-Human-Cancel-K27M.pdf", width=18, height=2, onefile=T, bg="transparent",fonts = NULL,useDingbats=FALSE)
...
pdf(file="AUCell-Human-Cancel-MET.pdf", width=18, height=2, onefile=T, bg="transparent",fonts = NULL,useDingbats=FALSE)
grid.arrange(grobs = p, ncol = 5, nrow=1, as.table = FALSE)
dev.off()
