...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-Tr089/Tr089.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"Tr089",sep="_")
sce<-SingleCellExperiment(assays = list(counts = my.umi))

mouse<-new("SingCellaR",sce)
mouse@sample_uniq_id<-"Tr089"
...
save(mouse,file="Tr089.SoupX.SingCellaR.rdata")
