...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-RERPK9/Tr075.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"Tr075",sep="_")
sce<-SingleCellExperiment(assays = list(counts = my.umi))

mouse<-new("SingCellaR",sce)
mouse@sample_uniq_id<-"Tr075"
...
save(mouse,file="Tr075.SoupX.SingCellaR.rdata")
