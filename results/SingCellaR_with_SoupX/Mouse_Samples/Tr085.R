...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-Tr085/Tr085.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"Tr085",sep="_")
sce<-SingleCellExperiment(assays = list(counts = my.umi))

mouse<-new("SingCellaR",sce)
mouse@sample_uniq_id<-"Tr085"
...
save(mouse,file="Tr085.SoupX.SingCellaR.rdata")
