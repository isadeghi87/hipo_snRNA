...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-EGNNNG/CD1_pons_cntrl.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"CD1_pons_cntrl",sep="_")

sce<-SingleCellExperiment(assays = list(counts = my.umi))
mouse <-new("SingCellaR",sce)
mouse@sample_uniq_id<-"CD1_pons_cntrl"
...
save(mouse,file="CD1_pons_cntrl.SingCellaR.rdata")
