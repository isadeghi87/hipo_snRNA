...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-RTJDH5/CD1_cortex_cntrl.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"CD1_cortex_cntrl",sep="_")
...
save(mouse,file="CD1_cortex_cntrl.SoupX.SingCellaR.rdata")
