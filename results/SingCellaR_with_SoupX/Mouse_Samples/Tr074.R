...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-8PAV6H/Tr074.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"Tr074",sep="_")
sce<-SingleCellExperiment(assays = list(counts = my.umi))

mouse<-new("SingCellaR",sce)
mouse@sample_uniq_id<-"Tr074"
...
save(mouse,file="Tr074.SoupX.SingCellaR.rdata")
