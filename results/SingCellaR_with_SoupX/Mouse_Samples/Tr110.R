...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-Tr110/Tr110.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"Tr110",sep="_")
sce<-SingleCellExperiment(assays = list(counts = my.umi))

mouse<-new("SingCellaR",sce)
mouse@sample_uniq_id<-"Tr110"
...
save(mouse,file="Tr110.SoupX.SingCellaR.rdata")
