...
my.umi<-readRDS("../../../cellranger_results/mouse/K35R-Tr091/Tr091.soupX.adjusted.rds")
colnames(my.umi)<-paste(colnames(my.umi),"Tr091",sep="_")
sce<-SingleCellExperiment(assays = list(counts = my.umi))

mouse<-new("SingCellaR",sce)
mouse@sample_uniq_id<-"Tr091"
...
save(mouse,file="Tr091.SingCellaR.rdata")
