...
PDX@SingCellR_object_files=c("RCXXB47_XP1_pellet.SoupX.SingCellaR.rdata",
...
get_variable_genes_for_integrative_data_by_fitting_GLM_model(PDX,mean_expr_cutoff = 0.1,disp_zscore_cutoff = 0.05)
...
saveRDS(PDX,file="MET_PDX_SoupX.SingCellaR.No_batch_correction.rds")
##################NNLM##################################