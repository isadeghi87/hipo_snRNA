...
p[[1]]<-plot_umap_label_by_AUCell_score(human,AUCell_gene_set_name = "Astrocyte-like",AUCell_cutoff = 0.1,
                                        AUCell_score = AUC.scores,point.size = 0.1,selected.sampleID=c("1_RCXXB47_XP1_pellet","1_Tr068"),
                                        IsShowOnlySampleIDs = T, IsDownsample = T,downsample.size = 13262,showLegend = F)

p[[2]]<-plot_umap_label_by_AUCell_score(human,AUCell_gene_set_name = "OPC/NPC-like",AUCell_cutoff = 0.1,
                                        AUCell_score = AUC.scores,point.size = 0.2,selected.sampleID=c("1_RCXXB47_XP1_pellet","1_Tr068"),
...
p[[1]]<-plot_umap_label_by_AUCell_score(human,AUCell_gene_set_name = "Astrocyte-like",AUCell_cutoff = 0.1,
                                        AUCell_score = AUC.scores,point.size = 0.1,selected.sampleID=c("1_Tr082","1_Tr083"),
                                        IsShowOnlySampleIDs = T, IsDownsample = T,downsample.size = 13262,showLegend = F)

p[[2]]<-plot_umap_label_by_AUCell_score(human,AUCell_gene_set_name = "OPC/NPC-like",AUCell_cutoff = 0.1,
                                        AUCell_score = AUC.scores,point.size = 0.2,selected.sampleID=c("1_Tr082","1_Tr083"),
                                        IsShowOnlySampleIDs = T, IsDownsample = T,downsample.size = 13262
                                        ,showLegend = F)
