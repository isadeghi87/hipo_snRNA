...
human<-readRDS(file="MET_PDX_SoupX.SingCellaR.No_batch_correction.rds")
...
################Harmony2##################
SrunHarmony(human,covariates = c("sampleID","sequencer","tenx_version"),
...
saveRDS(human,file="MET_PDX_samples.SoupX.SingCellaR.Harmony_v1.rds")
################CCA######################